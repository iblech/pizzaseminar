...
<\body>
  ...
  standard theory of expected values with a decisive focus on an intuitive
  view on this topic.>>
  ...
  <\theorem>
    ...
    countable collection of disjoint sets with
  ...
  of ``probability mass'' on the whole probability
  space.<version-both|<version-suppressed>| <todo|I wouldn't speak of
  ``center of mass'', since this concept implies some spatial location, but
  rather of ``average''>>
  ...
  <\definition>
    ...
    countable collection of disjoint sets>
    <math|B<rsub|i>\<subset\>\<Omega\>> with
    <math|<big|pluscup><rsub|i\<in\>I>B<rsub|i>=\<Omega\>>. We construct the
    <math|\<sigma\>>-Algebra generated by all countable unions and
    intersections of the <math|B<rsub|i>> sets
    <math|\<cal-F\>\<equiv\>\<sigma\><around*|(|<around*|{|B<rsub|i>|}><rsub|i\<in\>I>|)>>.
  ...
  <\remark>
    ...
    a more general notion of conditional expectation in the next section. The
    last property can be taken as ``The mean value of all centers of masses
    of disjoint subsets is equal to the actual center of mass''.
  </remark>

  <\remark>
    <label|rem:prog>Note that we took the following order of steps while
  ...
  <\remark>
    ...
    <reference|def:condExp> and is by uniqueness thus identical to the more
  ...
  <\remark>
    ...
    measurability criterion on the conditional expectation means: When we ask
  ...
  <\theorem>
    ...
    <math|\<sigma\>>-Algebras and <math|X,Y\<in\>L<rsup|1><around*|(|\<Omega\>,\<frak-A\>,\<bbb-P\>|)>>.
    Then
    ...
    <\enumerate-roman>
      ...
      <math|\<bbb-E\><around*|[|<around*|\||X|\|>\<divides\>\<cal-F\>|]>\<geqslant\><around*|\||\<bbb-E\><around*|[|X\|\<cal-F\>|]>|\|>>.
  ...
  <\remark>
    ...
    Property <em|iii.> then means that if all preimages of <math|X> are in
  ...
  <\remark>
    A last attempt at interpretation
  ...
  X<rprime|'> <text|is> \<frak-A\><text|-measurable>|}>|<point|-4.9282147109406|3.87700092604842>>|<math-at|L<rsup|2><around*|(|\<Omega\>,\<cal-F\>,\<bbb-P\>|)>=<around*|{|Y\<in\>L<rsup|2><around*|(|\<Omega\>|)>:
  ...
  open but <math|g<rsup|-1><around*|(|R|)>=<around*|{|\<omega\><rsub|2>|}>\<nin\>\<sigma\><around*|(|f|)>>.
  ...
  (non-constructively) by this lemma:

  Assume <math|X:<around*|(|\<Omega\>,\<frak-A\>,\<bbb-P\>|)>\<rightarrow\><around*|(|E,\<cal-E\>|)>>
  is a random variable with values in a measurable space <math|E> and
  ...
  <\definition>
    ...
    <math|Z=\<bbb-E\><around*|[|Y\|X|]>> the <em|conditional expectation of
    <math|Y> given <math|X=x>>, in symbols
  ...
  <\remark>
    Why can we reasonably denote <math|\<varphi\>> by
    ...
    <reference|def:condExpCountable>) and for the irregular case (continuous
  ...
  <\remark>
    ...
    sense for a.s. all <math|x\<in\>E> where the exception set depends on
    <math|Y>.
  </remark>
  ...
  <\definition>
    ...
    a <em|Markov Kernel from <math|<around*|(|\<Omega\><rsub|1>,\<frak-A\><rsub|1>|)>>
    to <math|<around*|(|\<Omega\><rsub|2>,\<frak-A\><rsub|2>|)>>>, if
  ...
  <\definition>
    ...
    sub-<math|\<sigma\>>-Algebra. Assume we have a Markov kernel
    <math|\<kappa\><rsub|Y,\<cal-F\>>:\<Omega\>\<times\>\<cal-E\>\<rightarrow\><around*|[|0,\<infty\>|]>>
    from <math|<around*|(|\<Omega\>,\<cal-F\>|)>> to
  ...
  <\example>
    ...
    In symbols we also write <math|f<rsub|Y\|X><around*|(|x,y|)> =
...
<\auxiliary>
  <\collection>
    ...
    <\associate|figure>
      ...
      <tuple|normal|Conditional expectation as a
      projection.|<pageref|auto-7>>
      ...
      is open but <with|mode|<quote|math>|g<rsup|-1><around*|(|R|)>=<around*|{|\<omega\><rsub|2>|}>\<nin\>\<sigma\><around*|(|f|)>>.
