...
\author[Kleine Bayessche AG]{\vspace{-0.5em}\\\includegraphics[scale=0.8]{\bannerimage} \\[1.0em] Ingo Blechschmidt \\[-0.3em] {\scriptsize December 17th, 2014}}
...
\setbeamertemplate{frametitle}[default][colsep=-1bp,rounded=false,shadow=false,center]
...
\frame{\frametitle{Digit recognition}
  \centering
  \includegraphics[width=\textwidth]{pca-digit-recognition}
  \par
}
