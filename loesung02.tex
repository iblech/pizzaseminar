...
g$ zwei Morphismen~$P\to 1$ sind (und $1$ terminal ist), gilt auch $!\circ h=g$. (Das rechte Dreieck k
ommutiert.)
...
\[X \coprod 0 \cong X\] % Bin nicht sicher, ob hier \amalg als Symbol für des Koprodukt nicht besser wäre
