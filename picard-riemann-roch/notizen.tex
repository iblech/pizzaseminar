...
unendlichdimensionale Raum der holomorphen Funktionen auf~$\CC$.} und für~$i > \dim X$
...
Achsenkreuz in~$\CC^2$ ist ein Beispiel für eine reduzible Hyperfläche.
...
Divisor zu einem bestimmten Schnitt \emph{des Geradenbündels~$\L$}. Dieser war
