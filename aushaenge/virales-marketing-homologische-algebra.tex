...
\page{%
  \huge
  \textbf{Konkrete Zahlenwerte}
  spielen in der Homologischen Algebra
  eine große Rolle.
}

\page{%
  \ldots \scalebox{1.5}{Nicht!}
}

\page{%
  Leitest du noch Funktionen ab \ldots
}

\page{%
  oder schon \textbf{Funktoren}?
}

\page{%
  Rechtsadjungierte Funktoren
  bewahren Limiten.
}
...
\page{%
  Manche Dinge kann man nicht derivieren.
}

\page{%
  Für alles andere gibt es Homologische Algebra.
}
