...
eine wegweisende Arbeit von Jeremy Butterfield und Chris Isham
zurück~\cite{butterfield:isham:1,butterfield:isham:2}, welche dann von weiteren
...
des Artikels~\cite{topos:aqt}. Die grundlegende Idee ist folgende:
...
mathematische Alternativuniversen. Diese Zutatenwollen wir in den folgenden
...
Abbildung~$\ul{\Sigma} \to \ul{\mathbb{IR}}$. Diese Zuordnung ist
injektiv.\end{prop}
