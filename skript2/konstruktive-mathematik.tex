...
\subsection{Die umgekehrte Richtung}
...
intuitionistischer Logik zu klassischer Logik ja $\varphi \Leftrightarrow
\varphi^\#$ klassisch folgen.

Ein klassischer Mathematiker hat es also schwerer, konstruktiv arbeitende
Kollegen zu verstehen. XXX Garbenmodelle usw.
...
nur das Nilpotenzkriterium (Proposition \label{intersectprim}) und das auch anderweitig nützliche
...
Primideal~$\pp$ werden, folgt aus dem gegebenen Beweis von~$Z(a_1) \wedge
...
In diesem Abschnitt wollen wir zeigen, dass auch dieses Prinzip konstruktiv
...
Radikalideal in~$\ZZ[x_1,\ldots,x_n]$ sein.\end{proof}
