...
\newcommand{\listedmotto}[2]{%
  ...
  \addcontentsline{lom}{section}{\textnormal{\textbf{Motto \ref{#1}.} #2}}%
}
...
Bolzanos~\ref{bolzano} zum Zwischenwertsatz Einblicke in die Haltung der
...
Referenzen. Die Vortragsfolien~\cite{topos:sqt:slides} geben einen ersten
Überblick.
