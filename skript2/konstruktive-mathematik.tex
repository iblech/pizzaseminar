...
\begin{defn}Eine \emph{Prägarbe} auf einem topologischen Raum~$X$ (oder einer
...
\begin{defn}Eine Prägarbe~$\F$ auf~$X$ heißt genau dann \emph{Garbe}, wenn
...
\Gamma(U,\F)$ mit~$s|_{U_i} = s_i$ für alle~$i$ geben.\end{defn}
% XXX: Wort "Überlapp"
...
man auf universelle Art und Weise aus Prägarben Garben machen kann. Die
Garbifizierung der Prägarbe der konstanten Funktionen ist dann gerade die Garbe
der lokal konstanten Funktionen.\end{bem}
