...
Man kann \emph{alle} Beweise gewöhnlicher Mathematik, die man
gemeinhin als "`vollständig und präzise ausformuliert"' bezeichnet, als
...
ihm eine Ableitung der Sequenz~$\top \seq \bot$ gibt. Andernfalls heißt es
...
klassisch gilt. Mit dieser kann sie daher ihre Kollegen verstehen, ohne ihre
Logik verlassen zu müssen.
...
\begin{proof}Man kann leicht nachvollziehen, dass die
...
In Tafel~{bhk} ist festgelegt, nach welchen Spielregeln Alice und Eve bei
solchen Diagonalen miteinander kommunizieren müssen. Exemplarisch seien einige
nochmal betont:
\begin{itemize}
...
\item Für die Negation als Spezialfall gilt folgende Spielregel: Wenn Eve von
...
\begin{bem}Wer Zeitsprünge dieser Form betrügerisch findet, hat die
