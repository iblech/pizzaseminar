...
werden -- etwa explizite Schranken für Konstanten oder explizite Zeugen von
Existenzbehauptungen.


\subsection{Friedmans Trick}
...
\subsection{Dynamische Methoden in der Algebra}

\[ \top \seq{} Z(0) \]
\[ Z(x) \wedge Z(y) \seq{} Z(x+y) \]
\[ Z(x) \seq{} Z(rx) \]
\[ Z(1) \seq{} \bot \]
\[ Z(xy) \seq{} Z(x) \vee Z(y) \]
...
Die Tafel~\ref{ideale:z} zeigen die Ideale des Rings~$\ZZ$.
