...
Variablen die Aussage nicht verändert. Dieselbe Beispielaussage können wir also
auch in der Form
\[ n + n = n \quad\Longrightarrow\quad \forall u\?\NN{:}\ n + u = u \]
notieren. Wenn wir auch noch über die Variable~$n$ quantifizieren, erhalten wir
eine Aussage im \emph{leeren Kontext}:
...
in Tafel~\ref{ableitungsregeln} aufgeführten Ableitungsregeln verwendet.
\end{defn}
