...
% XXX: e+pi, e-pi nicht beide rational.
...
\begin{bsp}Die Kategorien der Gruppen, Vektorräume und topologischen Räume sind
keine Topoi.\end{bsp}
...
% XXX: "Vereinigungen" im letzten Satz ist das falsche Wort.
...
\end{enumerate}
\end{prop}
% XXX: Ersten Teil mit Nonsens beweisen.
...
% XXX: Genauer, welche sind es nicht?
% XXX: Messen, inwieweit exp auf globalen Schnitten nicht surjektiv ist:
% Chern-Klasse!
...
der Funktionalgleichung gibt (wobei diese Teillösungen auf Überlapps nicht
...
% Erklären, dass man mit der Topossprache nichts machen kann, was man nicht
% ohne sie könnte.

% Kripke-Joyal: top und bottom fehlen.
